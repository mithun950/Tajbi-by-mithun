...
//    count btn 1
    ...
    <div>
        ...
        <button className="btn" onClick={handleBtn1}>লা ইলাহা ইল্লাল্লাহ</button>
        <button className="btn" onClick={handleBtn2}>আস্তাগফিরুল্লাহ </button>
        <button className="btn" onClick={handleBtn3}>আলহামদুলিল্লাহ</button>
